...
public class Excelutils {
	...
	public static int getTotalRows(String xlfile,String xlsheet) throws IOException {
	...
	public static int getTotalCells(String xlfile,String xlsheet) throws IOException {
		fi=new FileInputStream(xlfile);
		wb=new XSSFWorkbook(fi);
		sheet=wb.getSheet(xlsheet);
		row=sheet.getRow(0);
	...
	public static String getAllCellData(String xlfile, String xlsheet, int rowCount, int cellCount) throws IOException {
		fi=new FileInputStream(xlfile);
		wb=new XSSFWorkbook(fi);
		sheet=wb.getSheet(xlsheet);
...
//	}
	...
	public static void fillRedColour(String xlfile,String xlsheet,int rowCount,int cellCount) throws IOException {
	 ...
	 public static void makeHeaderBold(String path, String sheetName) throws IOException {
